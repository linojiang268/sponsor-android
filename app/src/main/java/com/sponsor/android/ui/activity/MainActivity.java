...
import com.sponsor.android.adapter.SponsorshipAdapter;
import com.sponsor.android.constract.ui.activity.BaseActivity;
import com.sponsor.android.datasoure.SponsorshipData;
...
import com.sponsor.android.view.DividerItemDecoration;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SponsorshipAdapter sponsorshipAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sponsorships);
    ...
    private void initView() {
        ...
        // divider
        lvSponsorships.addItemDecoration(new DividerItemDecoration(MainActivity.this));

        sponsorshipData = new SponsorshipData();
        sponsorshipAdapter = new SponsorshipAdapter(MainActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btMine:
                login(MySponsorshipsActivity.class);
                break;
        }
    }
}
